...
op_halt_lbl:
    ...
    return CPU_HALT;
op_rol_lbl:
    return op_rol(cpu, mode, operand);
op_ror_lbl:
    return op_ror(cpu, mode, operand);
op_shr_lbl:
    return op_shr(cpu, mode, operand);
op_shl_lbl:
    return op_shl(cpu, mode, operand);
op_inx_lbl:
    return op_inx(cpu, mode, operand);
op_dex_lbl:
    return op_dex(cpu, mode, operand);
